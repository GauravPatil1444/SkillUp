...
type TabProps = NativeStackScreenProps<TabParamList, 'Login'>
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.btnspace}>
                ...
                {emailclick && <>
                    ...
                    <TextInput
                        ...
                        value={password}
                        onChange={() => { setemail(password) }}
                    />
                    <TouchableOpacity style={[styles.btns, { justifyContent: 'center', backgroundColor: 'rgba(165, 190, 252, 0.197)', }]} >
                        <Text style={[styles.btntxt, { fontWeight: 'bold' }]}>Login</Text>
                    </TouchableOpacity></>}
            ...
            <View style={styles.redirect}>
                <Text style={styles.btntxt}>Don't have an account? </Text>
                <TouchableOpacity onPress={() => { navigation.navigate('CreateAccount') }}>
                    <Text style={styles.redirectlink}>Create now</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
